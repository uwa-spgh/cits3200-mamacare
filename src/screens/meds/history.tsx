    ...
    <AppSafeView>
      ...
      >
        <View style={styles.headerRow}>
          ...
          <Text style={styles.title}>{t("medicationHistoryScreen.title")}</Text>
        </View>

        {adherenceHistory.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Ionicons name="time-outline" size={40} color="#C78A9D" />

            <Text style={styles.emptyTitle}>{t("medicationHistoryScreen.emptyTitle")}</Text>

            <Text style={styles.emptyText}>
              {t("medicationHistoryScreen.emptyDescription")}
            </Text>
          </View>
        ) : (
